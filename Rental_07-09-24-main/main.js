...
document.getElementById('location-search-form').addEventListener('submit', function (e) {
  ...
  alert('Searching cars available in: ' + location);
  // You can replace this alert with AJAX call to backend or filter logic
});
function viewDetails() {
  alert("Details of the selected car will be shown here.");
}
